...
@section('header')Manage Products @endsection
...
@section('body')
	...
	<table id="example" class="table table-striped table-bordered">
		...
		<tbody>
			@foreach($product as $this_product)
				<tr>
					<td>{{$this_product->name}}</td>
					<td><center>
					<button class="delete-modal btn btn-danger" name="{{$this_product->name}}" id="{{$this_product->id}}">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left input_mask">
					  <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
                        <input type="text" class="form-control has-feedback-left" id="name_product" placeholder="Name">
  ...
  <div class="modal fade" data-modal-color="green" id="successModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
		 <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><center>Product Added !</center></h4>
        </div>
      </div>
  ...
  <div class="modal fade" data-modal-color="red" id="delModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"><center>Delete Product?</center></h4>
        </div>
            <div class="modal-footer">
